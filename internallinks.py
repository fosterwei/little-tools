...
with open(r'C:\internal links\urls.txt', 'r') as file:
...
save_to_csv(suggestions, 'C:\internal links\interlink_suggestions_luxebites.csv', num_suggestions)
if no_suggestions:
    save_no_suggestions_to_file(no_suggestions, 'C:\internal links\no_suggestions_luxebites.txt')